...
class HistoryManagerTest {
    ...
    public void shouldAddTasksEpicsSubtasksToHistory() {
        ...
        Subtask subtask = new Subtask(1, "Subtask 1 Epic 1", "Description Subtask 1 Epic 1", "NEW", 1440L, LocalDateTime.of(2022, 10, 5, 12, 0), 2);
    ...
    public void shouldGetHistoryWithoutDeletedFirstTask() {
        Task task1 = new Task(1, "Task 1", "Description Task 1", "NEW", 1440L, LocalDateTime.of(2022, 10, 1, 12, 0));
        Task task2 = new Task(1, "Task 2", "Description Task 2", "NEW", 1440L, LocalDateTime.of(2022, 10, 3, 12, 0));
        Task task3 = new Task(1, "Task 3", "Description Task 3", "NEW", 1440L, LocalDateTime.of(2022, 10, 5, 12, 0));
